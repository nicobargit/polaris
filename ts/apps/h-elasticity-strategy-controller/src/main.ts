...
import { HorizontalElasticityStrategyKind, initPolarisLib as initMappingsLib } from '@polaris-sloc/common-mappings';
...
manager
    .startWatching({
        kindsToWatch: [{ kind: new HorizontalElasticityStrategyKind(), controller: new HorizontalElasticityStrategyController(polarisRuntime) }],
    })
